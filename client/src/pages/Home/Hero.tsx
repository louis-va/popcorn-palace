  ...
  return (
    <section className="grid grid-cols-2 gap-4 mt-8 sm:grid-cols-4 lg:grid-cols-6">
      <Card className="relative flex flex-col justify-between col-span-2 overflow-hidden sm:col-span-4 lg:row-span-2">
        <Typography as="h1" variant="h1">Popcorn Palace<br/><span className="text-white/70">Cinéma plain air</span></Typography>
        <Typography as="p" variant="p" className="mt-28">Une ambiance chaleureuse<br/>sur un rooftop au cœur de<br/>Bruxelles.</Typography>
        <img 
          src={heroImage}
